...
<head>
    ...
    <title>Registration - Velvet Vogue</title>
...
<body>
    <header>
        <nav>
            ...
            <div class="nav-tabs" id="navTabs">
                ...
                <div class="nav-icons">
                    <div class="CS">
                        <a href="..//HTML/customer-support.php"><img src="../Images/support customer.png" alt="Customer Support"></a>
                    </div>
    ...
    <main class="registration-main">
        <form action="../PHP/Verify_Login.php" method="POST" class="registration-form">
            <h1>Create Your Account</h1>
            <p>Join Velvet Vogue to enjoy exclusive benefits and a personalized shopping experience.</p>
            ...
            <div class="form-actions">
                ...
                <input type="button" value="Or Login" onclick="redirectToLogin()" class="login-btn">
            </div>
        </form>
    </main>
