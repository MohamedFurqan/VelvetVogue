        ...
        <div class="price-filter">
            ...
            <form method="GET" action="">
                <div class="filter-options">
                    ...
                    <a href="Accessories.php" class="filter-btn" style="background-color: #e74c3c;">Reset</a>
                </div>
            </form>
        </div>
            ...
            <div class="products-body">
                <table class="product-table">
                    ...
                    <?php
                        ...
                        if (!empty($gender)) {
                            $where_clause .= " AND Gender = '$gender'";
                        }
                        ...
                        $category = getaccessoriesbyid("products", $where_clause);
                                ...
                                <tr>
                                    ...
                                    <td class="btn">
                                        <form action="../PHP/cart_handler.php" method="POST">
                                            ...
                                            <button type="submit" class="order-btn" name="Add-to-cart-btn-Accessories">Add to Cart!</button>
                                        </form>
                                    </td>
                                </tr>
                        <?php
                            ...
                            echo "<tr><td colspan='6'>No accessories found matching your criteria.</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
